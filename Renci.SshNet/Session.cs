...
using SshNet.Security.Cryptography.Ciphers;
...
namespace SshNet
{
    ...
    public partial class Session : IDisposable
    {
        ...
        internal Session(ConnectionInfo connectionInfo)
        {
            ...
            //this.ClientVersion = string.Format(CultureInfo.CurrentCulture, "SSH-2.0-SshNet.SshClient.{0}", this.GetType().Assembly.GetName().Version);
            this.ClientVersion = string.Format(CultureInfo.CurrentCulture, "SSH-2.0-SshNet.SshClient.0.0.1");
        }
        ...
        private void ConnectSocks4()
        {
            ...
            //  Send username
            var username = new SshNet.Common.ASCIIEncoding().GetBytes(this.ConnectionInfo.ProxyUsername);
        ...
        private void ConnectSocks5()
        {
            ...
            switch (authenticationMethod)
            {
                ...
                case 0x02:
                    ...
                    var encoding = new SshNet.Common.ASCIIEncoding();
