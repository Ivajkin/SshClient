...
using SshNet.Security.Cryptography.Ciphers.Modes;
using SshNet.Tests.Common;
using SshNet.Tests.Properties;
using System.Linq;

namespace SshNet.Tests.Classes.Security.Cryptography.Ciphers
{
    /// <summary>
    ///
    /// </summary>
    ...
    public class AesCipherTest : TestBase
    {
        ...
        public void Test_Cipher_AES_128_CBC()
        {
            ...
            var testCipher = new SshNet.Security.Cryptography.Ciphers.AesCipher(key, new SshNet.Security.Cryptography.Ciphers.Modes.CbcCipherMode(iv), null);
        ...
        public void Test_Cipher_AES_128_CTR()
        {
            ...
            var testCipher = new SshNet.Security.Cryptography.Ciphers.AesCipher(key, new SshNet.Security.Cryptography.Ciphers.Modes.CtrCipherMode(iv), null);
